...
namespace Ejercicio_26_;

public class Program
{
    static void Main(string[] args)
    {
        /*Diseñar un programa que pida 3 números y los muestre en pantalla de mayor a menor.*/
        ...
        if (int.TryParse(usuario1, out int numero1))
        {
            ...
            if (int.TryParse(usuario2, out int numero2))
            {
                ...
                if (int.TryParse(usuario3, out int numero3))
                {
                    ...
                    WriteLine($"Los números de menor a mayor son: {mayor}, {medio}, {menor}");
